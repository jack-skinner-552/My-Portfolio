...
class ObjectRenderer:
    def __init__(self, game):
        ...
        self.crosshair = self.get_texture('resources/textures/crosshair.png', (10, 10))
        self.crosshair_pos = (HALF_WIDTH - self.crosshair.get_width() // 2, HALF_HEIGHT - self.crosshair.get_height() // 2)
